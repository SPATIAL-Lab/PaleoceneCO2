...
post.s = jags(data, NULL, parms, 
              "code/models/single_sample_simplest.R", n.iter = 1e5)
View(post$BUGSoutput$summary)
save(post.s, file = "out/sss.rda")

## Vary all primary environmental parameters
post.pE = jags(data, NULL, parms, 
               "code/models/single_sample_primaryEnv.R", n.iter = 5e5)
...
post.mE = jags(data, NULL, parms, 
               "code/models/single_sample_marEnv.R", n.iter = 5e5)
...
post.aE = jags(data, NULL, parms, 
               "code/models/single_sample_allEnv.R", n.iter = 5e5)
View(post.mE$BUGSoutput$summary)
...
post.mO = jags(data, NULL, parms, 
               "code/models/single_sample_mO.R", n.iter = 5e5)
