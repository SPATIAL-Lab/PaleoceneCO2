...
ages = ts(d18Of$age, mgcaf$age, d11BGrub$age, d11BTsac$age,
...
d = list(ai = ages$ts, 
         ...
         mgcaf.obs = mgcaf[, 2:3], mgcaf.ai = tsi[[2]],
         d11BGrub.obs = d11BGrub[, 2:3], d11BGrub.ai = tsi[[3]],
         d11BTsac.obs = d11BTsac[, 2:3], d11BTsac.ai = tsi[[4]],
         d13Cc.obs = d13Cc[, 2:3], d13Cc.ai = tsi[[5]],
         d18Oc.obs = d18Oc[, 2:3], d18Oc.ai = tsi[[6]],
         D47c.obs = D47c[, 2:3], D47c.ai = tsi[[7]])

parms = c("tempC", "pCO2", "MAT", "MAP",
          "TmPCQ", "PPCQ", "d18.p", "z_m", "d18O.s", "AET_PCQ", "S_z", "d13Cr",
          "pH", "d11Bsw", "sal", "d18Osw.sc", "d18Of.pr", "mgcasw")

post = jags(d, NULL, parms, "code/models/multi_sample.R")
